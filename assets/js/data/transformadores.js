...
/**
 * Suscripción realtime a la colección. Invoca `onData(items)` cada vez
 * que cambia la colección y retorna una función `unsubscribe()`.
 *
 * @param {object} filtros - mismos filtros que `listar`.
